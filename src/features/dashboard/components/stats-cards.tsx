          ...
          <div key={groupIndex}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="bg-background rounded-xl p-5 animate-pulse border border-border"
                >
            ...
            {group.cards.map((card, cardIndex) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div
                    className={`${card.bgIcon} p-2 rounded-lg transition-transform group-hover:scale-110`}
                  >
