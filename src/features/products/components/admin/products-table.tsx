      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-background hover:bg-background">
            ...
            <TableHead className="hidden md:table-cell text-muted-foreground">หมวดหมู่</TableHead>
            <TableHead className="hidden sm:table-cell text-muted-foreground text-center">สถานะ</TableHead>
