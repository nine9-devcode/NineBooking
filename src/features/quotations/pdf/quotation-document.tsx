/**
 * เอกสาร PDF ของใบเสนอราคา
 *
 * เดิมโค้ดชุดนี้ถูกเขียนซ้ำอยู่ใน route ถึงสามที่ (ของแอดมิน, ตัวพรีวิว และ
 * ตัวที่ออกจากหน้าคำสั่งจอง) แต่ละที่ register ฟอนต์ Sarabun เองและมี
 * StyleSheet ของตัวเอง แก้หัวกระดาษทีต้องไล่แก้สามที่
 *
 * ย้ายมาไว้ที่นี่เพื่อให้ route เหลือแค่ดึงข้อมูลกับตรวจสิทธิ์
 */
