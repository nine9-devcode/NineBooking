...
import { Document, Page, Text, View, pdfStyles, formatThaiDate, StyleSheet } from "@/lib/pdf"
      ...
      <Page size="A4" style={pdfStyles.page}>
          ...
          <View style={reportStyles.statsGrid}>
            <View style={reportStyles.statCard}>
              ...
              <Text style={reportStyles.statValue}>
                {data.totalMembers.toLocaleString()} คน
              </Text>
            </View>
            ...
            <View style={reportStyles.statCard}>
              ...
              <Text style={reportStyles.statValue}>
                {data.totalViews.toLocaleString()} ครั้ง
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={reportStyles.section}>
          <Text style={reportStyles.sectionTitle}>
            2. สถิติในช่วงเวลาที่เลือก ({startDate} - {endDate})
          </Text>
          ...
          <View style={reportStyles.statsGrid}>
            <View style={reportStyles.statCard}>
              ...
              <Text style={reportStyles.statValue}>
                {data.currentPeriodOrders.toLocaleString()} รายการ
              </Text>
              <Text
                style={[
                  reportStyles.statTrend,
                  data.orderTrend > 0
                    ? reportStyles.trendPositive
                    : data.orderTrend < 0
                      ? reportStyles.trendNegative
                      : reportStyles.trendNeutral,
                ]}
              >
                {data.orderTrend > 0 ? "+" : ""}
                {data.orderTrend}% จากช่วงก่อนหน้า
              </Text>
            </View>
            ...
            <View style={reportStyles.statCard}>
              ...
              <Text style={reportStyles.statValue}>
                {data.currentPeriodViews.toLocaleString()} ครั้ง
              </Text>
              <Text
                style={[
                  reportStyles.statTrend,
              ...
              >
                {data.viewTrend > 0 ? "+" : ""}
                {data.viewTrend}% จากช่วงก่อนหน้า
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={reportStyles.section}>
          ...
          <View style={reportStyles.statsGrid}>
            ...
            <View style={[reportStyles.statCard, { backgroundColor: "#dbeafe" }]}>
              ...
              <Text style={reportStyles.statValue}>
                {data.confirmedOrders.toLocaleString()}
              </Text>
        ...
        <View style={reportStyles.section}>
          ...
          <View style={reportStyles.statsGrid}>
            <View style={reportStyles.smallStatCard}>
              ...
              <Text style={reportStyles.smallStatValue}>
                {data.contactIssueStats.totalIssues.toLocaleString()}
              </Text>
            </View>
            <View style={reportStyles.smallStatCard}>
              <Text style={reportStyles.smallStatLabel}>ในช่วงที่เลือก </Text>
              <Text style={reportStyles.smallStatValue}>
                {data.contactIssueStats.issuesInPeriod.toLocaleString()}
              </Text>
            </View>
            <View style={reportStyles.smallStatCard}>
              <Text style={reportStyles.smallStatLabel}>รอดำเนินการ </Text>
              <Text style={reportStyles.smallStatValue}>
                {data.contactIssueStats.pendingIssues.toLocaleString()}
              </Text>
            </View>
          </View>
          ...
          {data.contactIssueStats.issuesByCategory.length > 0 && (
            <View style={{ marginTop: 5 }}>
              <Text
                style={{ fontSize: 9, fontWeight: "bold", marginBottom: 4, color: "#333333" }}
              >
        ...
        <View style={reportStyles.section}>
          ...
          <View style={reportStyles.statsGrid}>
            <View style={reportStyles.statCard}>
              ...
              <Text style={reportStyles.statValue}>
                {data.memberGrowthStats.newMembersInPeriod.toLocaleString()} คน
              </Text>
              <Text
                style={[
                  reportStyles.statTrend,
                  data.memberGrowthStats.memberGrowthTrend > 0
                    ? reportStyles.trendPositive
                    : data.memberGrowthStats.memberGrowthTrend < 0
                      ? reportStyles.trendNegative
                      : reportStyles.trendNeutral,
              ...
              >
                {data.memberGrowthStats.memberGrowthTrend > 0 ? "+" : ""}
                {data.memberGrowthStats.memberGrowthTrend}% จากช่วงก่อนหน้า
              </Text>
            </View>
        ...
        <View style={reportStyles.noteBox}>
          ...
          <Text style={reportStyles.noteText}>
            • ข้อมูลในรายงานนี้เป็นข้อมูล ณ เวลาที่สร้างรายงาน
            และอาจมีการเปลี่ยนแปลงแบบเรียลไทม์
          </Text>
          <Text style={reportStyles.noteText}>
...
export async function GET(request: NextRequest) {
  try {
    ...
    const pdfBuffer = await renderToBuffer(<SummaryReportPDF data={reportData} />)
