...
const OrderPDF = ({ order }: { order: any }) => {
  ...
  order.orderItems.forEach((item: any) => {
    ...
    if (item.pairedProductId && item.pairedProductName) {
      ...
      const existingPaired = group.pairedProducts.find(
        p => p.name === item.pairedProductName
      );
        ...
        <View style={pdfStyles.section}>
          ...
          <View style={pdfStyles.table}>
            ...
            <View style={pdfStyles.tableHeader}>
              ...
              <Text style={[pdfStyles.tableHeaderCell, { width: 60, textAlign: 'center' }]}>จำนวน </Text>
            </View>
                ...
                {item.pairedProducts.length > 0 ? (
                  item.pairedProducts.map((paired, pIndex) => (
                    <View key={pIndex} style={orderStyles.pairedProductRow}>
                      ...
                      <Text style={[pdfStyles.tableCell, { width: 60, textAlign: 'center', color: '#666666' }]}>
                  ...
                  <View style={{ backgroundColor: '#fafafa', borderBottomWidth: 1, borderBottomColor: '#f0f0f0' }}>
                    <Text style={orderStyles.noPairedText}>
                      — ไม่มีสินค้าจับคู่
                    </Text>
                  </View>
                )}
          ...
          <View style={orderStyles.summarySection}>
            ...
            <View style={[orderStyles.summaryRow, { borderTopWidth: 1, borderTopColor: '#eeeeee', paddingTop: 5, marginTop: 5 }]}>
              <Text style={[orderStyles.summaryLabel, { fontWeight: 'bold' }]}>รวมทั้งหมด:</Text>
