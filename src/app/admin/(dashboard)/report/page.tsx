      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <Button
            ...
            variant="outline"
            className="mt-4 border-border text-foreground hover:bg-card hover:text-foreground"
          >
            ลองใหม่
          </Button>
        </div>
          ...
          <div className="text-center space-y-1 text-sm text-muted-foreground">
            <p>
              ...
              <span className="text-foreground">
                {formatThaiBEDate(reportData.dateRange.start)} -{" "}
                {formatThaiBEDate(reportData.dateRange.end)}
              </span>
            </p>
            <p>
              <span className="font-medium text-muted-foreground">ข้อมูล ณ วันที่:</span>{" "}
              <span className="text-foreground">
                {formatThaiBEDateTime(reportData.generatedAt)}
              </span>
            </p>
          </div>
